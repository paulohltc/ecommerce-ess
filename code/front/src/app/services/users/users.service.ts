...
export class UsersService {
  ...
  private admin: User = { name: 'admin', CPF: '00000000001', email: 'admin@admin.com', password: '123', auth: 'Admin', offers: false };
  private client: User = { name: 'client-test', CPF: '00000000002', email: 'client@test.com', password: '123', auth: 'Cliente', offers: false };
  private employee: User = { name: 'employee-test', CPF: '00000000003', email: 'employee@test.com', password: '123', auth: 'Funcionário', offers: false };
  constructor() {
    this.users = new Map([
